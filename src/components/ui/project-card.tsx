  ...
  return (
    <div className="group relative block w-full h-full p-4 overflow-hidden bg-neutral-50 dark:bg-neutral-800 border border-black/[0.1] dark:border-white/[0.2] rounded-2xl flex flex-col">
      ...
      <div className="mt-4">
        ...
        >
          <button className="cursor-emoji w-full px-4 py-2 rounded-lg bg-neutral-700 dark:bg-neutral-700 text-neutral-50 dark:text-neutral-300 text-sm font-medium hover:bg-neutral-900 dark:hover:bg-neutral-600 transition-colors duration-300">
